...
size_t read_append_into_Output( int fd, Output* out,size_t* string_size){
	/*Append the result in the output buffer and manage size properly(actualize constructor new default size, prevent overflow. Return the previous max value. So you can stop reading when after a call returned value != string_size*/
