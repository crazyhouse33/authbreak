...
//Note that we finally dont use the generic _init for each classifier, because it would need to gather classifier specific stuff as return value for each one of them. By calling direct side effect parsing we avoid the problem
